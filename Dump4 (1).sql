...
--
-- Table structure for table `uso_pacote`
--

DROP TABLE IF EXISTS `uso_pacote`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `uso_pacote` (
  ...
  CONSTRAINT `uso_pacote_ibfk_1` FOREIGN KEY (`pacote_id`) REFERENCES `pacotes` (`id`),
  CONSTRAINT `uso_pacote_ibfk_2` FOREIGN KEY (`agendamento_id`) REFERENCES `agendamentos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `uso_pacote`
--

LOCK TABLES `uso_pacote` WRITE;
/*!40000 ALTER TABLE `uso_pacote` DISABLE KEYS */;
/*!40000 ALTER TABLE `uso_pacote` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-06-02  3:08:06
